...
namespace bc_system
{
    public partial class viewpayment : UserControl
    {
        ...
        public void load()
        {
            ...
            while (dr.Read())
            {
                dataGridView1.Rows.Add(dr[0], dr[1], dr[2], dr[3], dr[4], dr[5], dr[6], dr[7], dr[9]);
    ...
    private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                string Query = "update Req_member set Pay_status ='" + comboBox1.SelectedItem.ToString() + "'where username = '" + textBox1.Text + "'";
